# 03B_ml_espacial.R — Modelización ML con Componentes Espaciales
...
sar_model <- spatialreg::lagsarlm(formula_base, data = train_sf, listw = W, zero.policy = TRUE)
...
# Partición Train/Test (80/20) para entrenamiento de modelos ML
set.seed(42)
...
saveRDS(mejor_rmse_xgb, "datos/rmse_test_xgb.rds")
